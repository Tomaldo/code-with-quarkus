...
```
curl "https://nubesgen.com/demo-native.zip?iactool=TERRAFORM&region=westeurope&application=APP_SERVICE.free&runtime=DOCKER&database=NONE.free&gitops=true" | tar -xzvf -
```
